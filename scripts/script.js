...
FIX: Call to function updateCount was missing (). 
#################################################*/
  ...
  $newItemForm.on("submit", function(e) {
    ...
    $("li:last-child").addClass("favorite");
...
FIX: Added a addClass method to the newItemForm function
that checks last list item added and makes it a favorite.
#################################################*/	
...
Iterate through the $list to check the input against list values
Create an error message if the input matches an existing value
Set the text input back to blank.
Create an else that runs the form normally if its not a duplicate.
#################################################*/		
